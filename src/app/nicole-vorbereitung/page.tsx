...
const FAECHER: Fach[] = [
  ...
  {
    id: 'deutsch', name: 'Deutsch', icon: '📝', neu: false, farbe: '#FF7CB0', avatar: 'nica',
  ...
  {
    id: 'englisch', name: 'Englisch', icon: '🇬🇧', neu: false, farbe: '#37C978', avatar: 'nica',
  ...
  {
    id: 'spanisch', name: 'Spanisch (2. Fremdsprache)', icon: '🇪🇸', neu: true, farbe: '#FFB648', avatar: 'nica',
  ...
  {
    id: 'biologie', name: 'Biologie', icon: '🧬', neu: false, farbe: '#00C9A7', avatar: 'phil',
  ...
  {
    id: 'chemie', name: 'Chemie', icon: '⚗️', neu: true, farbe: '#8A5CFF', avatar: 'phil',
  ...
  {
    id: 'physik', name: 'Physik', icon: '⚡', neu: false, farbe: '#4F7CFF', avatar: 'phil',
  ...
  {
    id: 'geschichte', name: 'Geschichte', icon: '🏛️', neu: false, farbe: '#FF8C42', avatar: 'nica',
  ...
  {
    id: 'geografie', name: 'Geografie', icon: '🗺️', neu: false, farbe: '#37C978', avatar: 'phil',
...
export default function NicoleVorbereitung() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8F6FF', fontFamily: 'system-ui, sans-serif', paddingBottom: '60px' }}>
      ...
      {/* Hero */}
      <div style={{ background: 'linear-gradient(135deg, #8A5CFF, #6C8FFF, #FF7CB0)', padding: '32px 24px 70px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '680px', margin: '-40px auto 0', padding: '0 20px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '22px', padding: '24px', marginBottom: '24px', boxShadow: '0 8px 28px rgba(138,92,255,0.12)', border: '1px solid #F0EBFF' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
            <span style={{ fontSize: '24px' }}>🌟</span>
            <h2 style={{ fontSize: '17px', fontWeight: '800', color: '#1A1F36', margin: 0 }}>Neue Schule, neue Chancen</h2>
          </div>
          ...
          <div style={{ display: 'grid', gap: '10px' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', background: '#FAFAFF', borderRadius: '14px', padding: '12px 14px' }}>
        ...
        <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ fontSize: '11px', fontWeight: '700', color: '#8A5CFF', background: '#F2EBFF', padding: '3px 10px', borderRadius: '100px' }}>{neueFaecher.length} neu</span>
        </div>
        <p style={{ fontSize: '12px', color: '#9CA3AF', marginBottom: '14px' }}>Hier starten alle bei null — kein Vorwissen nötig, ein fairer Neubeginn für Nicole.</p>
        ...
        <p style={{ fontSize: '12px', color: '#9CA3AF', marginBottom: '14px' }}>Diese Fächer kennt Nicole schon — jetzt geht es darum, die Grundlagen sicher zu festigen.</p>
